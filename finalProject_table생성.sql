...
COMMENT ON COLUMN "ITEM"."D_NAME" IS '패키지가 Y인 경우에만 필요함';
...
COMMENT ON COLUMN "ORDERS"."O_NO" IS '주문 번호';
COMMENT ON COLUMN "ORDERS"."M_ID" IS '회원 ID';
COMMENT ON COLUMN "ORDERS"."O_PRICE" IS '총 결제금액';
COMMENT ON COLUMN "ORDERS"."O_DATE" IS '주문날짜';
COMMENT ON COLUMN "ORDERS"."O_POSITION" IS '상세보기페이지';
COMMENT ON COLUMN "ORDERS"."O_NAME" IS '받는분성함';
COMMENT ON COLUMN "ORDERS"."ZIPCODE" IS '우편번호';
COMMENT ON COLUMN "ORDERS"."O_ADDR" IS '받는 주소 변경 가능 (default 주문자주소)';
COMMENT ON COLUMN "ORDERS"."O_DETAIL" IS '상세주소';
COMMENT ON COLUMN "ORDERS"."O_TEL" IS '받는사람전화번호, 변경 가능( default 주문자전화번호)';
COMMENT ON COLUMN "ORDERS"."O_REQ" IS '배송요청사항';
COMMENT ON COLUMN "ORDERS"."O_COUNT" IS '주문상품개수';
...
CREATE TABLE "RESERVATION" (
	...
	"M_ID"  	VARCHAR2(50)		NOT NULL,
	"F_NO"	    NUMBER		        NOT NULL,
	"R_ZONE"	VARCHAR2(10)		    NULL,
	"R_STATUS"	NUMBER	DEFAULT 0	NOT NULL,
	"R_START"	NUMBER		            NULL,
	"R_PRICE"	NUMBER		            NULL,
	"R_ITEM"	VARCHAR2(100)		NOT NULL
);
...
COMMENT ON COLUMN "SECTOR"."S_STATUS" IS '0: 예약가능 1: 대기 2:예약';
