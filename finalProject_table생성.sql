...
COMMENT ON COLUMN "RESERVATION"."R_NO" IS '예약 번호';
COMMENT ON COLUMN "RESERVATION"."M_ID" IS '회원 ID';
COMMENT ON COLUMN "RESERVATION"."F_NO" IS '농장 번호';
COMMENT ON COLUMN "RESERVATION"."R_ZONE" IS '예약구역';
COMMENT ON COLUMN "RESERVATION"."R_STATUS" IS '0: 예약가능 1: 대기 2:예약 -- 관리자만 가능';
...
COMMENT ON COLUMN "SECTOR"."S_NO" IS '섹터 번호';
COMMENT ON COLUMN "SECTOR"."F_NO" IS '농장번호';
